...
Flutter Desktop monorepo for Android device screen mirroring via Scrcpy protocol. Melos-managed Dart pub workspace.
...
**adb_tools** — `AdbClient` (shell, forward, reverse, push, pair, connect), `AdbProcessRunner`.
