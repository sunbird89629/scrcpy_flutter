...
void main() {
  ...
  runApp(const ScrcpyViewExample());
}

class ScrcpyViewExample extends StatelessWidget {
  const ScrcpyViewExample({super.key});
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text('Failed to get devices: $e')),
        );
      }
    }
  }
                    ...
                    children: [
                      ScrcpyView(
                        ...
                        videoBackend: _WebViewBackend(
                          onStats: (stats) => setState(() => _statsJson = stats),
                        ),
                        onError: (err) {
                          ScaffoldMessenger.of(context).showSnackBar(
