...
Flutter desktop client for Android screen mirroring via the [scrcpy](https://github.com/Genymobile/scrcpy) protocol. A complete reimplementation of the scrcpy client functionality in Flutter.
